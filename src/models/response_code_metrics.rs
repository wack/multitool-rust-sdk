...
impl ResponseCodeMetrics {
    pub fn new(app_group: models::ApplicationGroup, created_at: String, deployment_id: u64, status_2xx_count: u32, status_4xx_count: u32, status_5xx_count: u32) -> ResponseCodeMetrics {
        ResponseCodeMetrics {
            app_group,
            created_at,
            deployment_id,
