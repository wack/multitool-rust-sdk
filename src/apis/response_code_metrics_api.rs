...
pub async fn create_response_code_metrics(configuration: &configuration::Configuration, workspace_id: &str, application_id: &str, deployment_id: i64, create_response_code_metrics_request: models::CreateResponseCodeMetricsRequest) -> Result<models::CreateResponseCodeMetricsSuccess, Error<CreateResponseCodeMetricsError>> {
